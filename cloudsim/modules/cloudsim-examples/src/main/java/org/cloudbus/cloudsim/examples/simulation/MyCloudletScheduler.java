 ...
 * 全部复制了CloudletSchedulerTimeShared类，加入了mips封装普通属性，以及在updateVmProcessing中
 * 加入一行 mipsShare.set(0,mips); 这样做的目的是将虚拟机速度更新为mips，mips是虚拟机原有cpu速度加上另
 * 一个虚拟机释放过来的一部分cpu速度
 */
public class MyCloudletScheduler extends CloudletScheduler {
     ...
     * @post $none
     */
    public MyCloudletScheduler(Double mips) {
        super();
        currentCPUs = 0;
        this.mips = mips;
    }
